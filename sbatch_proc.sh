...
#SBATCH --mail-user=Roeland.Hancock@uconn.edu	# Your email address
...
cd /scratch/psyc5171/roh17004/hw7
singularity run /scratch/psyc5171/containers/burc-lite.img /scratch/psyc5171/roh17004/hw7/run_afni.sh
